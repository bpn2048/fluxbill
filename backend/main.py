...
INCOMPLETE_COMMAND_FILLER_WORDS = {
    "a", "an", "the", "my", "me", "please", "now",
    "tab", "page", "screen", "section", "item", "thing",
    "one", "something", "anything", "new", "it", "this", "that",
}

INCOMPLETE_COMMAND_PROMPTS = (
    (NAVIGATION_VERBS, "What should I open: dashboard, invoices, customers, subscriptions, reports, or settings?"),
    (("create", "add", "new"), "What should I create: invoice, customer, or subscription?"),
    (("delete", "remove"), "What should I delete: invoice, customer, or subscription?"),
    (("update", "edit", "change"), "What should I update: invoice, customer, or subscription?"),
    (("search", "find"), "What should I search for?"),
    (("filter",), "What should I filter: invoices by amount or status?"),
)
